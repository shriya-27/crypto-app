...
const CoinDetails = () => {
  ...
  // here key is btns array ki values
  const switchChartStats = (key) => {
    switch (key) {
      case "24h":
        setDays("24h")
        setLoading(true) // since days change hone pr wapas fetch hoga
        break;
      case "7d":
        setDays("7d")
        setLoading(true) // since days change hone pr wapas fetch hoga
      ...
      case "200d":
        ...
        break;
      case "1y":
        setDays("365d") // since documentation mein 365 days le rha instead of 1 year
        setLoading(true) // since days change hone pr wapas fetch hoga
        break;
      default:
        setDays("24h")
  ...
  useEffect(() => {
    const fetchCoin = async()=>{
      ...
      try {
        ...
        setCoin(data); // passing this data as array
  ...
  return (
    <Container maxW={'container.xl'} >
      {loading? <Loader/> :(
          ...
          {/* Button, ispr click krne se chart update hoga */}
...
// the below are called "arrow function"
